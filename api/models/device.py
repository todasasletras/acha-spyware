...
class Device:
    ...
    def list_connected_devices() -> List[Device]:
        ...
        for line in result.stdout.splitlines()[1:]:
            if line.strip():
                parts = line.split()
                logger.debug("Obtem o id do dispositivo e defini o restante dos valores para 'Unknown' para evitar erros.")
                id = parts[0]
